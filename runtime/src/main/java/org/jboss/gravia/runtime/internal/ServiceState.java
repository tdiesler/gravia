...
final class ServiceState<S> implements ServiceRegistration<S>, ServiceReference<S> {
    ...
    ServiceState(ServiceManager serviceManager, Module owner, long serviceId, String[] classNames, ValueProvider<S> valueProvider, Dictionary properties) {
    ...
    public S getScopedValue(Module module) {
        ...
        try {
            ...
            if (result == null) {
                ...
                serviceManager.fireFrameworkEvent(module, FrameworkEvent.ERROR, sex);
            }
        } catch (Throwable th) {
        ...
        if (valueProvider.isFactoryValue()) {
            ...
            if (factoryHolder != null) {
                try {
                    ...
                    serviceManager.fireFrameworkEvent(bundle, FrameworkEvent.WARNING, sex);
                }
            }
        }
    }
    ...
    public Bundle getBundle() {
        return (isUnregistered() ? null : ownerModule.adapt(Bundle.class));
    }


    public void addUsingBundle(Module bundleState) {
        synchronized (this) {
    ...
    public void removeUsingBundle(Module bundle) {
        synchronized (this) {
            if (usingModules != null)
    ...
    public Set<Module> getUsingBundlesInternal() {
        synchronized (this) {
            if (usingModules == null)
    ...
    public Bundle[] getUsingBundles() {
        synchronized (this) {
            ...
            for (Module aux : usingModules)
                bundles.add(aux.adapt(Bundle.class));
    ...
    public boolean isAssignableTo(Bundle bundle, String className) {
        return isAssignableTo(bundle.adapt(Module.class), className);
    }
    ...
    class ServiceFactoryHolder<T> {
        ...
        T getService() {
            ...
            if (useCount.get() == 0) {
                ...
                synchronized (module) {
                    T retValue = (T) factory.getService(module.adapt(Bundle.class), getRegistration());
                    if (retValue == null)
                        return null;
        ...
        void ungetService() {
            ...
            if (useCount.decrementAndGet() == 0) {
                synchronized (module) {
                    factory.ungetService(module.adapt(Bundle.class), getRegistration(), value);
                    value = null;
                }
            }
        }
