...
public class RepositoryXMLReader implements RepositoryReader {
    ...
    private Resource readResourceElement(XMLStreamReader reader) throws XMLStreamException {
        ...
        if (caps.size() > 0) {
            Capability ccap = (Capability) caps.get(0);
            ...
            if (urlspec != null) {
                ...
                try {
                    ...
                    throw new RepositoryStorageException("Invalid content URL" + urlspec);
                }
                builder = new URLResourceBuilder(contentURL, ccap.getAttributes());
